from sparseLinban.Results import Result
from sparseLinban.environment.Environment import Environment
from sparseLinban.arms.LinearArm import LinearArm
from sparseLinban.arms.LastFM import LastFM
from sparseLinban.arms.MovieLens import Movielens
...
class MTL(Environment):
    ...
    def _lenk_preprocessing(self):
        lenk = sio.loadmat('sparseLinban/arms/lenk_data.mat')
