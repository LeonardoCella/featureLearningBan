...
from sparseLinban.arms import Arm
...
class LastFM(Arm):
    ...
    def __init__(self, N, d, K, T, n_rep):
        ...
        self._shrinkItem = 30
        self._shrinkUser = 30
        self._ratings_preprocessing()  # Filtering out seldom samples
    ...
    def _task_creation(self):
        ...
        task_path = "sparseLinban/arms/LastFM/XTasks_N{}_d{}_T{}_K{}_nrep{}.pkl".format(self._N, self._d, self._minT, self._K, self._nrep)
        users_path = "sparseLinban/arms/LastFM/listUID_N{}_d{}_T{}_K{}_nrep{}.pkl".format(self._N, self._d, self._minT,
                                                                                   self._K, self._nrep)
...
#                suboptimals = negative.reshape((self._minT, self._K - 1))
    ...
    def _context_mng(self):
        ...
        path = "sparseLinban/arms/LastFM/contexts_SVD{}.pkl".format(self._d)
    ...
    def _users_mng(self):
        ...
        path = 'sparseLinban/arms/LastFM/usersDF_SVD{}.pkl'.format(self._d)
        if Path(path).exists() and False:
    ...
    def _ratings_preprocessing(self):
        ...
        with open("sparseLinban/arms/LastFM/user_artists.dat", 'r') as f:
...
if __name__ == '__main__':
    istance = LastFM(25, 20, 10, 30, 1)  # N,d,k,min_T,compSimUser
